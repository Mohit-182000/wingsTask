...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('user.update',$user->id) }}" method="post" id="userForm" name="userForm">
                            ...
                            <div class="form-row">
                                <div class="col-md-12  pr-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $user->name }}" name="name" maxLength="50" value="" data-rule-required="true" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="title">Email  <span class="text-danger">*</span> </label>
                                        <input type="text" value="{{ $user->email }}" name="email" maxLength="50" value="" data-rule-required="true" class="form-control">
                                    </div>  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="cpwd" data-rule-equalTo="#password" value="" class="form-control">
                                    </div>  
                                </div>
                            </div>
                        </div>
